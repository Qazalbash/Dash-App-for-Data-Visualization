...
def display_map(selected_year: int, selected_month: int,
                selected_radio: str) -> px.choropleth_mapbox:
    ...
    fig.update_layout(coloraxis_colorbar=dict(
        title=f"{selected_year}-{selected_month}", ticktext=[0, data.max()]))
